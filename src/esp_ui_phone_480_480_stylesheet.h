...
/* Home */
#define ESP_UI_PHONE_480_480_DARK_HOME_DATA()                              \
    {                                                                      \
        .status_bar = ESP_UI_PHONE_480_480_DARK_STATUS_BAR_DATA(),         \
        .navigation_bar = ESP_UI_PHONE_480_480_DARK_NAVIGATION_BAR_DATA(), \
        .app_launcher = ESP_UI_PHONE_480_480_DARK_APP_LAUNCHER_DATA(),           \
        .recents_screen = ESP_UI_PHONE_480_480_DARK_RECENTS_SCREEN_DATA(),           \
        .flags = {                                                    \
            .enable_status_bar = 1,                                   \
...
/* Manager */
#define ESP_UI_PHONE_480_480_DARK_MANAGER_DATA()             \
    {                                                                \
        .gesture = ESP_UI_PHONE_480_480_DARK_GESTURE_DATA(), \
        .recents_screen = {                                  \
...
/* Phone */
#define ESP_UI_PHONE_480_480_DARK_STYLESHEET()               \
    {                                                        \
        .core = ESP_UI_PHONE_480_480_DARK_CORE_DATA(),       \
        .home = ESP_UI_PHONE_480_480_DARK_HOME_DATA(),       \
        .manager = ESP_UI_PHONE_480_480_DARK_MANAGER_DATA(), \
    }
