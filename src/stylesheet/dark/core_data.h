...
LV_IMG_DECLARE(esp_ui_phone_480_480_wallpaper_image_drak);

/* Home */
#define ESP_UI_PHONE_480_480_DARK_CORE_HOME_DATA()                             \
    {                                                                                  \
        .background = {                                                                \
            .color = ESP_UI_STYLE_COLOR(0x1A1A1A),                                      \
            .wallpaper_image_resource = ESP_UI_STYLE_IMAGE(&esp_ui_phone_480_480_wallpaper_image_drak), \
        },                                                                             \
        .text = {                                                                      \
...
/* manager */
#define ESP_UI_PHONE_480_480_DARK_CORE_MANAGER_DATA() \
    {                                                     \
        .app = {                                          \
            .max_running_num = 3,                         \
        },                                                \
...
/* Core */
#define ESP_UI_PHONE_480_480_DARK_CORE_INFO_DATA_NAME    "EUI-Phone Drak 800x480"
#define ESP_UI_PHONE_480_480_DARK_CORE_DATA()                     \
    {                                                                     \
        .name = ESP_UI_PHONE_480_480_DARK_CORE_INFO_DATA_NAME,    \
        .screen_size = ESP_UI_STYLE_SIZE_RECT(480, 480),            \
        .home = ESP_UI_PHONE_480_480_DARK_CORE_HOME_DATA(),       \
        .manager = ESP_UI_PHONE_480_480_DARK_CORE_MANAGER_DATA(), \
    }
